<?php
    ...
    class finance_cta extends \Elementor\Widget_Base {
        ...
        <section class="pr6-get-section">
			<div class="container">
            <div class="pr6-get-content" data-background="<?php echo esc_url($cta_img);?>">
					<div class="row align-items-center">
						<div class="col-lg-8">
							<div class="pr6-get-left wow fadeInUp">
						...
						<div class="col-lg-4">
							<div class="pr6-secondary-btn wow fadeInRight">
