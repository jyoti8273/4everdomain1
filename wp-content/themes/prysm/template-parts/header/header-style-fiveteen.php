...
<header class="main-header business-header-three">
            ...
            <div class="inner-container">
                <div class="clearfix">
                    ...
                    <div class="top-left pull-left">
                        <ul class="info-list">
                            <?php
								if(!empty($prysm['header_15_infos'])):
								$headerinfos = $prysm['header_15_infos'];
									foreach((array)$headerinfos as $hinfo):
							?>
                            <li><span class="icon"><i class="<?php echo esc_attr($hinfo['header15-icon-class']);?>"></i></span><a href="<?php echo esc_url($hinfo['header15_info_link']);?>"><?php echo esc_attr($hinfo['header15_info_title']);?></a></li>
                            <?php 
							endforeach;
							endif;
							?>
                    ...
                    <div class="top-right pull-right">
                        <!-- Social Box -->
                        <?php if(!empty($prysm['sidebar_social_info_15'])):?>
                        <ul class="social-box">
                            <?php foreach($prysm['sidebar_social_info_15'] as $icon):?>
            ...
            <div class="inner-container clearfix">
                ...
                <div class="nav-outer clearfix">
                    ...
                    <div class="outer-box clearfix">
                        ...
                        <!-- Nav Btn -->
                        <div class="nav-btn navSidebar-button navSidebar-button sidemenu-btn"><span class="icon flaticon-menu"></span></div>
...
<div class="search-popup">
    ...
    <form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
        <div class="form-group">
            <input type="search" name="s" value="<?php echo get_search_query(); ?>" placeholder="<?php esc_attr_e('Search Here', 'prysm'); ?>" required="">
