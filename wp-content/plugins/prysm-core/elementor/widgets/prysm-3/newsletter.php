<?php
    ...
    class prysm3_newsleter extends \Elementor\Widget_Base {

        public function get_name() {
            return 'prysm3_newsleter';
        }

        public function get_title() {
            return __( 'prysm3 Newsleter', 'prysm' );
        }
        ...
        <div class="pr5-ft-content">
            <div class="row">
                <div class="col-md-6">
                    <div class="pr5-ft-left wow fadeInLeft">
                        <div class="pr5-headline">
                            <h3><?php echo esc_html($newsleter_title);?></h3>
                        </div>
                        <div class="pr5-ft-form">
                            <?php echo do_shortcode($newsleter_id);?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="pr5-ft-right wow fadeInRight">
                        <img src="<?php echo esc_url($newsleter_img);?>" alt="<?php echo esc_html($newsleter_title);?>">
                    </div>
                </div>
            </div>
        </div>
