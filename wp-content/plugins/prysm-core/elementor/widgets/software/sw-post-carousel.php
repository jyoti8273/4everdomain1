<?php
    ...
    class sw_post_carousel_slider extends \Elementor\Widget_Base {

        public function get_name() {
            return 'sw_post_carousel_slider';
        }

        public function get_title() {
            return __( 'Software Post Slide', 'prysm' );
        }
        ...
        <section class="pr3-blog-section">
            <span class="pr3-blog-left-shape"><img src="assets/images/pricing/object-1.png" alt=""></span>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="pr3-blog-item">
                                    ...
                                    <div class="pr3-blog-content">
                                        ...
                                        <div class="pr3-blog-meta">
                                            <span class="author">Hasib Sharif-</span>
