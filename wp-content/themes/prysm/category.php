<?php
	...
	$top_heading = single_cat_title( '', false );
	$breadcrumb_bg = !empty($prysm['category-background']['url']) ? !empty($prysm['category-background']['url']) : "";
?>
	...
	<section id="pr-breadcrumb" class="pr-breadcrumb-section position-relative" data-background="<?php echo esc_url($breadcrumb_bg);?>">
		...
		<div class="container">
			<div class="pr-breadcrumb-content  text-center headline">
				<h2><?php echo esc_html( $top_heading ) ? $top_heading : esc_html__("category" , 'prysm'); ?></h2>
				<?php if(!empty($prysm['category_breadcrumb'])): ?>
...
<!-- End of category feed section
	============================================= -->
<?php if(!empty($prysm['category-contactsection']['category_bottom_section'])): ?>
<!-- Start of newslatter section
	============================================= -->
	<section id="pr-newslatter" class="pr-newslatter-section position-relative">
		<span class="pr-newslatter-img position-absolute"><img src="<?php echo esc_url($prysm['category-contactsection']['category-main-bglogo']['url']);?>"></span>
		<div class="container">
			<div class="pr-newslatter-content d-flex justify-content-between align-items-center">
				<div class="pr-newslatter-text headline pera-content">
					<p><?php echo wp_kses($prysm['category-contactsection']['category-bottom-title'] , prysm_expanded_alowed_tags())?></p>
				</div>
				<?php if($prysm['category-contactsection']['category_bottom_form']): ?>
