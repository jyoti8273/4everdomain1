<?php
	...
	$top_heading 		= single_month_title('', false);
	$breadcrumb_bg = !empty($prysm['archive-background']['url']) ? !empty($prysm['archive-background']['url']) : "";
?>
	...
	<section id="pr-breadcrumb" class="pr-breadcrumb-section position-relative" data-background="<?php echo esc_url($breadcrumb_bg);?>">
		...
		<div class="container">
			<div class="pr-breadcrumb-content  text-center headline">
				<h2><?php echo esc_html( $top_heading ) ? $top_heading : esc_html__("Month" , 'prysm'); ?></h2>
				<?php if(!empty($prysm['archive_breadcrumb'])): ?>
...
<!-- End of archive feed section
	============================================= -->
<?php if(!empty($prysm['archive-contactsection']['archive_bottom_section'])): ?>
<!-- Start of newslatter section
	============================================= -->
	<section id="pr-newslatter" class="pr-newslatter-section position-relative">
		<span class="pr-newslatter-img position-absolute"><img src="<?php echo esc_url($prysm['archive-contactsection']['archive-main-bglogo']['url']);?>"></span>
		<div class="container">
			<div class="pr-newslatter-content d-flex justify-content-between align-items-center">
				<div class="pr-newslatter-text headline pera-content">
					<p><?php echo wp_kses($prysm['archive-contactsection']['archive-bottom-title'] , prysm_expanded_alowed_tags())?></p>
				</div>
				<?php if($prysm['archive-contactsection']['archive_bottom_form']): ?>
