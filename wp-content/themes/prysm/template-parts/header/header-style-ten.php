					...
					<div class="inner-container clearfix">
						...
						<div class="nav-outer clearfix">
							...
							<div class="outer-box clearfix">
								<div class="login-box">
									<a class="login" href="#"><span class="icon flaticonv10-user-3"></span>Log In</a>
								</div>
								...
								<!-- Btn Box -->
								<div class="btn-box">
									<a href="<?php echo esc_url($prysm['header_button_link']['url']);?>" class="theme-btn btn-style-two"><span class="txt"><?php echo esc_attr($prysm['header_button_link']['text']);?></span></a>
								</div>
								<?php endif;?>
							</div>
						</div>
