<?php
    ...
    class weba_faq extends \Elementor\Widget_Base {
        ...
        public function get_title() {
            return __( 'Web Agency FAQ', 'prysm' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => \Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .accordion-box-two.style-three .block .acc-btn' => 'color: {{VALUE}} ',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'          => esc_html__( 'Typography', 'prysm' ),
                    'selector'       => '{{WRAPPER}} .accordion-box-two.style-three .block .acc-btn',
                    'fields_options' => [
                        'font_family' => [
                            'default' => 'Fira Sans',
                        ],
        ...
        <!-- Faq Section Two -->
        <section class="faq-section-two style-two">
            <div class="pattern-layer-one" style="background-image: url(<?php echo esc_url($bg_pattern);?>)"></div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="accordion-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column">
                                ...
                                <!-- Accordian Box Two -->
                                <ul class="accordion-box-two style-three">
