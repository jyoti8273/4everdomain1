<?php
    ...
    class its_newsleter extends \Elementor\Widget_Base {

        public function get_name() {
            return 'its_newsleter';
        }

        public function get_title() {
            return __( 'ITsolution Newsleter', 'prysm' );
        }
        ...
        <div class="pr20-footer-section">
            <div class="pr20-footer-top">
                <div class="pr20-ft-sb-area">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="pr20-footer-sb-left">
                        ...
                        <div class="col-lg-6">
                            <div class="pr20-footer-sb-right">
