<?php
    ...
    class business_v2_partners_section extends \Elementor\Widget_Base {

        public function get_name() {
            return 'business_v2_partners_section';
        }

        public function get_title() {
            return __( 'Business V2 Partners', 'prysm' );
        }
        ...
        <section class="clients-section-five style-two">
