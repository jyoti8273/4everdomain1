<?php
    ...
    class prysm2_button extends \Elementor\Widget_Base {

        public function get_name() {
            return 'prysm2_button';
        }

        public function get_title() {
            return __( 'Prysm2 Button', 'prysm' );
        }
        ...
        ?>
       <div class="pr2-primary-btn">
            <a href="<?php echo esc_url($button_link['url']);?>" <?php echo esc_attr($target); echo esc_attr($nofollow)?>><?php echo esc_html($btn_text);?></a>
        </div>
      <?php
